//
//  shiraImgViewController.swift
//  fmdb_start
//
//  Created by 山本シェーン on 2018/09/24.
//  Copyright © 2018年 山本シェーン. All rights reserved.
//

import UIKit

class shiraImgViewController: UIViewController,UIScrollViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        //画像のセット
        imageView = UIImageView(image: UIImage(named: "shiraKouki\(getPage).png"))
        //よくわからん
