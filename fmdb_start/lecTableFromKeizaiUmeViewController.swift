//
//  lecTableFromKeizaiUmeViewController.swift
//  fmdb_start
//
...
class lecTableFromKeizaiUmeViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //2or3群
        //今回は3群専攻にしておく
        selectedSennkou = userDefault.integer(forKey: "selectGunKeizaiNum")
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "UmeCellKeizai") as! lecTableFromKeizaiUmeTableViewCell
    ...
    func typeNum(gettype:Int) -> Int {
        if gettype < 3{
            ...
            return 3
        }else if gettype < 18{//ここまでは経営経済同じ
            return 4
        }else if gettype < 24{//100は2or3群のどちらかから１２単位
            return 100
        }else if gettype < 39{//200は1~5群から３０単位
            return 200
        }else{
            return 10//その他自由単位
        }
